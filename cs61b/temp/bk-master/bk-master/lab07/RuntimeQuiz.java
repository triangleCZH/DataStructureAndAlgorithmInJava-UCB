public class RuntimeQuiz {
    ...
    public static Runtime f3_runtime = Runtime.LINEAR;// FIXME: 6/30/16 
    ...
    public static Runtime f4_runtime = Runtime.LOGLINEAR;// FIXME: 6/30/16
    ...
    public static Runtime f7_omega_runtime = Runtime.LINEAR;// FIXME: 6/30/16
