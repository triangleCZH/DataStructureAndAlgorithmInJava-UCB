 ...
 */
class PermutationData { //permutation means how one letter maps with another
    PermutationData() {
        int a = 0; //      there must be some better one to figure it out
    }
