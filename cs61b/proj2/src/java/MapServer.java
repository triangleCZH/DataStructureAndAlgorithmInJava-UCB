...
//        for(long a: idSet) {
//            GraphNode node = g.getNodeinfo().get(a);
//
...
//        return name;
    ...
    public static List<Map<String, Object>> getLocations(String locationName) {
        //get all the nodes required, each gets a map of string and object
//        ArrayList<Long> idSet = trie.search(locationName);
//        List<Map<String, Object>> rtn = new ArrayList<>();
//        for (Long a: idSet) {
//            GraphNode temp = g.getNodeinfo().get(a);
//            if (temp.getname().equals(locationName)) {
//                //equals means that they are exactly the same; // FIXME: 8/8/16 this is not fast enough
//                Map<String, Object> pair = new HashMap<>();
//                pair.put("lat", temp.getlat());
//                pair.put("lon", temp.getlon());
//                pair.put("name", temp.getname());
//                pair.put("id", temp.getid());
//                rtn.add(pair);
//            }
//        }
//        return rtn;
